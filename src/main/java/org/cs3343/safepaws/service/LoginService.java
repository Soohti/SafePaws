...
public class LoginService {
    ...
    // 创建新账户
	/*
	 * public void createAccount(String username, String password) { Account account
	 * = new Account(username, password); try { DbManager.insertAccount(account); //
	 * 将账户信息插入数据库 } catch (SQLException e) {
