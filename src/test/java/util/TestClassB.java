...
public class TestClassB extends TestClassA {
    ...
    public TestClassB(int newId, TestClassC newForeign, TestState newState,
                      int newChangeV) {
    ...
    public boolean equals(Object o) {
        ...
        if (!super.equals(o)) {
            return false; // Check equality of the superclass properties
        }
    ...
    public int hashCode() {
        int result =
                super.hashCode(); // Include the hash code of the superclass
